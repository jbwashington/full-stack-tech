  ...
  return (
      ...
      <div className="flex flex-col sm:flex-row p-4 overflow-y-auto">
        <div className="sm:w-1/3 p-4">
          <h2 className="text-2xl font-bold mb-4">The next big step in business automation.</h2>
          <p className="text-xl mb-4">
            Seamlessly integrate ChatGPT with your existing systems, processes, and data to perform automated tasks and make decisions in real-time.
          </p>
        </div>

        <div className="sm:w-2/3 p-4 flex flex-col rounded bg-white">
